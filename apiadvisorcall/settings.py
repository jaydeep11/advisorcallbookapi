"""
Django settings for apiadvisorcall project.
...
SECRET_KEY = '6=$lk+67o=mx1(0t)l(kyynzxzuk$gxfwe+*5y*#gyyunsy6jf'
...
ROOT_URLCONF = 'apiadvisorcall.urls'
...
WSGI_APPLICATION = 'apiadvisorcall.wsgi.application'
